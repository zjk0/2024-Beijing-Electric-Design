...
#define CHINESE_WIDTH 20
#define CHINESE_HEIGHT 20
...
#define CS_PIN		GPIO_PIN_9 //Chip select
#define RESX_PORT	GPIOA
#define RESX_PIN	GPIO_PIN_8 //Reset pin
#define	DC_PORT		GPIOB
#define DC_PIN		GPIO_PIN_6 //DATA / Command select
...
extern uint8_t BasicalWaveFrequency[5];
extern uint8_t CarrierWaveFrequency[5];
extern uint8_t DirectSignalAttenuation[7];
extern uint8_t DirectSignalDelay[7];
extern uint8_t MultipathSignalAttenuation[7];
extern uint8_t MultipathSignalDelay[7];
extern uint8_t AM_ModulationDegree[6];
extern uint8_t InitialPhaseDifference[6];
extern uint8_t AdjustValue[4];
extern uint8_t FrequencyData[2];
extern uint8_t Amplitude[2];
extern uint8_t Delay[2];
extern uint8_t ModulationDegree[3];
extern uint8_t AmplitudeValidVaule[6];
...
void ShowBasicalWaveFrequency (void);
void ShowCarrierWaveFrequency (void);
void ShowDirectSignalAttenuation (void);
void ShowDirectSignalDelay (void);
void ShowMultiSignalAttenuation (void);
void ShowMultiSignalDelay (void);
void ShowAM_ModulationDegree (void);
void ShowInitialPhaseDifference (void);
