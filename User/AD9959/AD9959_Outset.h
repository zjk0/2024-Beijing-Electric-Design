...
// typedef struct {
//     double Parameter[3];
//     double ParameterStep[3];
//     double ParameterMax[3];
//     double ParameterMin[3];
// } WaveInformation;

// extern enum StepMode step_mode;
// extern WaveInformation Wave;

// extern double WaveParameter[3];
// extern double WaveParameterStep[3];
// extern double WaveParameterMax[3];
// extern double WaveParameterMin[3];
...
extern void AD9959_SetFreAmpPha (double fre, int amp, int pha);
#endif
